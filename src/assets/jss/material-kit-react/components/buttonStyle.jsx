...
const buttonStyle = {
    ...
    boxShadow:
      `0 2px 2px 0 ${makeRGBA(primaryColor, '0.14')},
       0 3px 1px -2px ${makeRGBA(primaryColor, '0.2')}, 
       0 1px 5px 0 ${makeRGBA(primaryColor, '0.12')}`,
    "&:hover,&:focus": {
      backgroundColor: primaryColor,
      boxShadow:
        `0 14px 26px -12px ${makeRGBA(primaryColor, '0.42')},
         0 4px 23px 0px ${makeRGBA(primaryColor, '0.12')},
          0 8px 10px -5px ${makeRGBA(primaryColor, '0.2')}`
    }
    },
    secondary: {
        backgroundColor: secondaryColor,
        boxShadow:
            `0 2px 2px 0 ${makeRGBA(secondaryColor, '0.14')},
       0 3px 1px -2px ${makeRGBA(secondaryColor, '0.2')}, 
       0 1px 5px 0 ${makeRGBA(secondaryColor, '0.12')}`,
        "&:hover,&:focus": {
            backgroundColor: secondaryColor,
            boxShadow:
                `0 14px 26px -12px ${makeRGBA(secondaryColor, '0.42')},
         0 4px 23px 0px ${makeRGBA(secondaryColor, '0.12')},
          0 8px 10px -5px ${makeRGBA(secondaryColor, '0.2')}`
        }
    },
    info: {
    ...
    outline: {
        ...
        "&:focus,&:hover": {
            background: makeRGBA("#000000", 0.1)
        },
        "&$primary": {
            "&, &:focus, &:hover": {
                color: primaryColor
            ...
            "&:focus, &:hover": {
                background: makeRGBA(primaryColor, 0.1)
            }
        },
        "&$secondary": {
            "&, &:focus, &:hover": {
            ...
            "&:focus, &:hover": {
                background: makeRGBA(secondaryColor, 0.2)
            }
        },
        "&$info": {
            "&,&:focus,&:hover": {
